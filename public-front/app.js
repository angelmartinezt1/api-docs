...
// Configuration
const API_BASE = 'https://3we0wv453m.execute-api.us-east-1.amazonaws.com/dev/api';
    ...
    return `
        <div class="service-card">
            ...
            <div class="service-card-footer">
                ...
                <a 
                    href="https://d26uet9f7b3hzf.cloudfront.net/index.html?spec=${service.spec_url || API_BASE + '/specs/' + service.spec_filename}" 
                    target="_blank" 
